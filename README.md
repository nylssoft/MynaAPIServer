...
The first goal was to write a REST API server with the framework provided by ASP.NET core.
...
everbody that has provided feedback and will provide feedback in the future.
...
I didn't expect how easy it was to write an arcade game in JavaScript. I was my first time to use the Canvas and I'm still
fascinated how powerfull the API is and how fast in runs in modern browsers. 
...
The storage of passwords is the most sensitve part I can image and a password manager stores all passwords in a single place
...
The next project motivated by the pandamic was an online secure diary.
...
The programing exercise was how to securly encrypt and decrypt data in a modern browser using the crypto API.
...
I use this very often, i.e. to track improvements for the portal or to store senstive information or any knowledge
...
by the portal administrator. A very simple version of a webiste content management system.
...
physical copy anymore in the digial information era. So I scanned these documents and uploaded then as PDF file in the portal.
...
Another game of my childhood was chess. I played it very often. The was the next project. The challenge with chess was the
...
the configuration of chess engine, e.g. Zappa or Stockfish. If configured you can also play against a computer.
