...
namespace APIServer.Migrations.DbPostgres
{
    ...
    [Migration("20260702200644_AddUserPhotoStorage")]
    partial class AddUserPhotoStorage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIServer.Database.DbUserPhoto", b =>
                {
                    b.Property<long>("DbUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("APIServer.Database.DbUserPhoto", b =>
                {
                    b.HasOne("APIServer.Database.DbUser", "User")
                        .WithOne("UserPhoto")
                        .HasForeignKey("APIServer.Database.DbUserPhoto", "DbUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
