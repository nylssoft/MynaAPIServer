...
namespace APIServer.Diary
{
    ...
    {
        DiaryEntryModel GetEntry(IPwdManService pwdManService, string authenticationToken, DateTime date);

        List<DiaryEntryModel> GetMonthEntries(IPwdManService pwdManService, string authenticationToken, DateTime date);
